...
//    }
    ...
    func setupGestures() {
        ...
        // 3. Object Interaction (1-Finger Pan)
        // Note: If you have a separate handlePan or handleObjectPan, use that here.
...
//    
    ...
    func getPlaneIntersection(location: CGPoint, planeNormal: SIMD3<Float>, planePoint: SIMD3<Float>) -> SIMD3<Float>? {
        ...
        return rayPlaneIntersection(rayOrigin: rayOrigin, rayDirection: rayDirection, planePoint: planePoint, planeNormal: planeNormal)
    }
    ...
    func setEntityTransparency(_ entity: Entity?, alpha: Float) {
        ...
        // Uses the forEachDescendant extension from your project to find all meshes
        entity.forEachDescendant { child in
            if child is ModelEntity {
                var opacityComp = child.components[OpacityComponent.self] ?? OpacityComponent(opacity: 1.0)
                opacityComp.opacity = alpha
                child.components.set(opacityComp)
            }
        }
    }
