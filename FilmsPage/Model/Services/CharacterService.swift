    ...
    private func load() {
        ...
        characters = [
            CharacterItem(
                ...
                pose: [
                    CharacterPoseItem(id: UUID(), name: "Standing", imageName: "woman1_img", modelFilename: "Scene"),
            ...
            CharacterItem(
                ...
                imageName: "man1_img",
                pose: [
                    CharacterPoseItem(id: UUID(), name: "Standing", imageName: "man1_img", modelFilename: "LewScene"),
