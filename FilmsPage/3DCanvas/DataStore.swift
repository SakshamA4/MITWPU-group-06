...
enum ToolType: CaseIterable {
    ...
    var items: [SpawnItem] {
       ...
       case .prop:
        ...
        case .sky:
            return [
                SpawnItem(title: "Daylight Sky", imageName: "cloud.sun", modelFileName: "sky_day"),
                SpawnItem(title: "Sunset Sky", imageName: "sunset", modelFileName: "sky_sunset"),
                SpawnItem(title: "Midnight Sky", imageName: "moon.stars", modelFileName: "sky_night"),
                
                // This is your new Real Image option
                SpawnItem(title: "Real Clouds", imageName: "sky_image_1", modelFileName: "sky_image_1")
            ]
        }
    }
}
