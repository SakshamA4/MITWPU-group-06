...
//                .init(name: "Arri",      imageName: "Arri",    description: "Professional cinema camera used on film sets.")
        ...
        .init(
            ...
            items: [
                ...
                .init(
                    name: "Zoom-in Shot",
                    imageName: "Zoom-in Shot",
                    description: "The camera gradually moves closer to the subject to highlight details or increase focus/intensity."
                ),
                .init(
                    name: "Zoom-out Shot",
                    imageName: "Zoom-out Shot",
                    description: "The camera pulls away from the subject to reveal more surroundings or reduce focus."
                )
