//
//  ScenesAndCameraCollectionViewCell.swift
//  FilmsPage
//
...
class ScenesAndCameraCollectionViewCell: UICollectionViewCell {
    ...
    func configure(with item: LibraryItem) {
        featuredLabel.text = item.title
        featuredImageView.image = UIImage(named: item.imageName)
...
private extension ScenesAndCameraCollectionViewCell {
